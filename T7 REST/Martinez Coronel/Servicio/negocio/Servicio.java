  ...
  public Response consulta(@FormParam("id_usuario") int id_usuario) throws Exception {
    ...
    try {
      PreparedStatement stmt_1 = conexion.prepareStatement(
          "SELECT a.id_usuario,a.email,a.nombre,a.apellido_paterno,a.apellido_materno,a.fecha_nacimiento,a.telefono," +
                  "a.genero,b.foto FROM usuarios a LEFT OUTER JOIN fotos_usuarios b ON a.id_usuario=b.id_usuario" +
                  " WHERE a.id_usuario=?");
      try {
